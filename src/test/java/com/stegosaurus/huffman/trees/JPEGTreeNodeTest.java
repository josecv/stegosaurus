...
public class JPEGTreeNodeTest {
  ...
  public void testAsMap() {
    ...
    TByteObjectMap<HuffmanCode> retval = tree.asMap();
    /* We don't use the primitive version just for easy iteration here. */
    ...
    for(Byte key : expected.keySet()) {
      assertEquals("Wrong value for key " + key, expected.get(key),
        retval.get(key));
    }
  }
