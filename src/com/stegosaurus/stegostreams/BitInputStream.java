 ...
 * 0th byte will be returned, then the second to least significant bit of the 0th
 * byte, and so on (Little Endian).
 * @author joe
 */
public class BitInputStream extends InputStream {
    ...
    /**
     * Get the number of available bits that can be read without blocking, or
     * 0 if there is nothing left to read.
